...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    AccountAuthenticator(Context context) {
        super(context);
        if (context instanceof SessionEntry) {
            loginActivityClass = ((SessionEntry) context).getSessionEntryActivity();
        }
        else{
            throw new NotImplementedError("Please set your login activity");
        }
